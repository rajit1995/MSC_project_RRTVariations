function RRTState = getpath(RRTState)
    ...
    while ~isempty(queue)
        ...
        if currentNode == RRTState.endNode
            % Reconstruct the path from end to start
           currentNode = RRTState.endNode;
           RRTState.path = currentNode;

            while currentNode ~= RRTState.startNode
